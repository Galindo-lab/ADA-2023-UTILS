...
/**
 * Reemplazar valor en una posicion, la posicion ya debe existir previamente
 * WARNING: una vez terminado se usar el valor de node debe ser regresado a NULL
 * para evitar conflictos con la lista.
 *
