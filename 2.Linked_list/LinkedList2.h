...
/**
 * @brief Macro para obtener el valor en una posición y convertirlo a un tipo específico.
 *
...
/**
 * @brief Inserta un nuevo nodo con los datos especificados en la posición indicada.
 *
 * @param list Puntero a la lista.
